    ...
    <body style=background-image:url(images/backgroundone.jpg);background-repeat:no-repeat;background-size:115% 115%>
        <div class="page">
            ...
            <div class="message">
                <form action="helpGetMemberMess" method="post">
                    <div class="r0"></div>
                    <div class="r1"><span>地点：</span><span>青少年活动中心</span></div>
                    <div class="r2"><span>时间：</span><span>2015.8.1-8.2</span></div>
                    <div class="r3"><span>内容：</span><span>手工、趣味实验教学</span></div>
                    <div class="r4"><span>人数：</span><span>10人</span></div>

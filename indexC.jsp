...
<html>
    ...
    <body style=background-image:url(images/backgroundthree.jpg);background-repeat:no-repeat;background-size:100% 100%>
        <div class="page">
            <div class="top1">
                <a href="Login.jsp"><img src="images/logo.png" target="_blank" title="点击我登录"></a>
            </div>    
            <div class="top2">
            ...
            <div class="top3">
                <span>访客，欢迎您</span>|没有账号？立即<a href="Register.jsp"><span>注册</span></a>
            </div>
            ...
            <div class="message">
                <form action="helpGetMemberMess" method="post">
                    <div class="r0"></div>
                    <div class="r1"><span>地点：</span><span>温江金强大学城小区</span></div>
                    <div class="r2"><span>时间：</span><span>2015.8.25-8.26</span></div>
                    <div class="r3"><span>内容：</span><span>把手工课带入社区</span></div>
                    <div class="r4"><span>人数：</span><span>20人</span></div>
                    <div class="r5"><input type="submit" value="点击我报名参加" style="background-color:darkgray; width:160px; height: 30px; font-size:20px;color:black;"/></div>
                </form>
            </div>
            <div class="name">
                  <p>“大哥哥大姐姐课堂”活动</p>
            ...
            <div class="pagenumber"> 
               ...
               <div class="a1">
                  <form action="indexB.jsp" method=post>

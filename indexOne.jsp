...
<html>
    ...
    <body style=background-image:url(images/backgroundone.jpg);background-repeat:no-repeat;background-size:115% 115%>
        <div class="page">
            ...
            <div class="top3">
                <jsp:getProperty name="login" property="logname" /><span>，欢迎您</span>|<a href="helpExitLogin"><span>退出登录</span></a>|<a href="helpGetOldMess"><span>修改个人信息|</span></a>
            </div>
            ...
            <form action="helpGetMemberMess" method="post">
                    ...
                    <div class="r5"><input type="hidden" name="volunteer" value="超级小猫Scat计划">
